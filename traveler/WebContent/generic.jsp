...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<!-- Header -->
		<header id="header"> <a href="index.html" class="logo">Massively</a>
		</header>
		...
		<div id="main">
			...
			<!-- Post -->
			<section class="post">
				<header class="major"> <span class="date">April 25, 2017</span>
					<h1>
						This is a<br /> Generic Page
					</h1>
					<p>
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
					...
					Pellentesque leo mauris, consectetur id ipsum.</p>
			</section>
